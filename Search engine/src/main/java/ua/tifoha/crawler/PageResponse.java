...
public class PageResponse {
    ...
    private ByteOutputStream content;
    private String contentType;

    public PageResponse(Status status, Map<String, String> headers, InputStream inputStream) throws IOException {
        this.status = status;
        this.headers = headers;
        content = new ByteOutputStream();
        content.write(inputStream);
