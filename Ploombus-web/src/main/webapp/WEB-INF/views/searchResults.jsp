            ...
            <div class="result">
                ...
                <c:if test="${searchResult.totalPages > 1}">
                    ...
                    <div class="pagination">
                        <p class="Pl"><span class="blue">P</span><span class="red">l</span></p>
                        <ul>
                            <li class="back">
                            ...
                            <c:forEach var="i" begin="${firstPage}" end="${lastPage}">
                                <li class="${(i -1) == searchResult.pageNumber ? "active" : "no-active"}">
                                    <a href="${searchUrl}?queryString=${queryString}&pageNumber=${i - 1}&pageSize=${searchResult.pageSize}">${i}</a>
                                </li>
                            </c:forEach>
                            <li class>
                                <p class="mber"><span class="green">m</span><span class="yellow">b</span><span
                                    class="red">e</span><span class="green">r</span></p>
                            </li>
                            <li class="next">
